...
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.VirtualCollection.State;
...
/*
  ...
  */
    ...
    private void confirmPublishWithWarnings(AjaxRequestTarget target, IModel<VirtualCollection> model, List<String> errors, boolean frozen) {
        ...
        StringResourceModel stringResourceModel = new StringResourceModel("collections.publishwarningsconfirm", model);
