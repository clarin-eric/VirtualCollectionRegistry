...
public class PidLinkTest {
    ...
    public void testIsHandle() {
        assertTrue(PidLink.isHandle("hdl:123/456"));
        assertTrue(PidLink.isHandle("https://hdl.handle.net/123/456"));
        assertTrue(PidLink.isHandle("http://hdl.handle.net/123/456"));
        assertFalse(PidLink.isHandle("https://handle.net/123/456"));
        assertFalse(PidLink.isHandle("http://handle.net/123/456"));
    }

    @Test
    public void testIsDoi() {
        assertTrue(PidLink.isDoi("doi:10.5281/zenodo.3694223"));
        assertTrue(PidLink.isDoi("https://doi.org/10.5281/zenodo.3694223"));
        assertTrue(PidLink.isDoi("http://doi.org/10.5281/zenodo.3694223"));
        assertTrue(PidLink.isDoi("https://dx.doi.org/10.5281/zenodo.3694223"));
        assertTrue(PidLink.isDoi("http://dx.doi.org/10.5281/zenodo.3694223"));
    }

    @Test
    public void testIsNbn() {
        assertTrue(PidLink.isNbn("urn:nbn:whatever"));
    }
}
