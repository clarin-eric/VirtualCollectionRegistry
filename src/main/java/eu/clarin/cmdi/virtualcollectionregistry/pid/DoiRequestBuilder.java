...
public class DoiRequestBuilder {
    ...
    public static DoiRequest createGenerateDoiRequest(String prefix, String postfix, VirtualCollection vc, String baseUri) {
        DoiRequest request = createBasicDoiRequest(vc, baseUri);
        request.setDoi(prefix+"/"+postfix);
        return request;
    }

    public static DoiRequest createAutoGeneratedDoiRequest(String prefix, VirtualCollection vc, String baseUri) {
        DoiRequest request = createBasicDoiRequest(vc, baseUri);
