...
public final class RecordList {
	 ...
	 * Constructor.
	 * 
	 * @param records     the list of records from the repository
	 * @param offset      the offset of this result list
	 * @param hasMore     <code>true</code> if these are the last records of
	 *                    the result set, <code>false</code> otherwise
	 * @param totalCount  the total count of records
	 */
	public RecordList(List<Record> records, int offset, boolean hasMore, int totalCount) {
		if (records == null) {
