...
/**
 * An item in the repository. This adapter interface is used by the OAI
 * provider to get information about an item from the repository.
 */
public interface Record {
	 ...
	 * 
	 * @return the list of sets to which the records belongs to
	 *         or <code>null</code> if it does not belong to any sets or the
     *         repository does not support set
	 */
	public List<String> getSetSpecs();

	/**
	 * Get the actual item as the native object. This object is passed to
	 * the <code>writeObject</code> method of <code>MetadataFormat</code>.
	 * 
	 * @return the object as a native object or
     *         <code>null</code> if the record only contains header information
	 * @see MetadataFormat#writeObject(
	 *          eu.clarin.cmdi.virtualcollectionregistry.oai.OAIOutputStream,
     *          Object)
	 */
	public Object getItem();
	
	/**
	 * Get the class of the native object. The class is needed to
	 * determine if a MetadataFormat can write the native object
