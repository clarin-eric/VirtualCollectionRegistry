...
public final class RestUtils {
    ...
    public static void checkRestApiRedirection(HttpServletRequest req, String redirectLocation) {
        ...
        if(!acceptsHtml(acceptableMediaTypes)) {
            VirtualCollectionMarshaller.Format outputFormat = RestUtils.getOutputFormatNoWildcard(acceptableMediaTypes);
            logger.info("Requested format=" + outputFormat.name());
            if (outputFormat == VirtualCollectionMarshaller.Format.JSON || outputFormat == VirtualCollectionMarshaller.Format.XML) {
