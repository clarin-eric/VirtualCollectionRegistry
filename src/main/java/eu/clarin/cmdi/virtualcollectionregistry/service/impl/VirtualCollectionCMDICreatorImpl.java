...
public class VirtualCollectionCMDICreatorImpl implements VirtualCollectionCMDICreator {
    ...
    private CMD.Components createComponents(VirtualCollection vc, CMD.Resources resources) {
        ...
        if (vc.getType() == VirtualCollection.Type.INTENSIONAL) {
            final CMD.Components.VirtualCollection.GeneratedBy generatedBy = new CMD.Components.VirtualCollection.GeneratedBy();
            //TODO: add 'generated by' values
            virtualCollection.setGeneratedBy(generatedBy);
        }
