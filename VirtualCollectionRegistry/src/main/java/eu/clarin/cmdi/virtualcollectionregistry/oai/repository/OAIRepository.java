...
/**
 * Interface for the OAI provider for talking to the repository.
 * A repository needs to implements this interface in order to be used
 * with the OAI provider.
 */
public interface OAIRepository {
     ...
     * <em>ListMetadataFormats</em> verb.
	 * This value will be cached by the OAI provider upon initialization.
	 * 
	...
	/**
	 * Get the sets, which are generally supported by the repository.
	 * Used for the <em>ListSets</em> verb.
	 * This value will be cached by the OAI provider upon initialization.
	 *
