 ...
 * interface to talk to the metadata format converter.
 */
public interface MetadataFormat {

    /**
     * Get the prefix for this metadata format. Used by the
     * <em>ListMetadataFormats</em>, <em>GetRecord</em> and <em>ListRecords</em>
     * verbs.
     * 
     ...
     * <em>ListMetadataFormats</em> <em>GetRecord</em> and <em>ListRecords</em>
     * verbs. Even though the return type of this method is String, it should
    ...
    /**
     * Transform an object into the metadata format and write it to the output
     * stream. Used by the <em>GetRecord</em> and <em>ListRecords</em> verbs.
     * 
     * @param stream
     *            the output stream
     * @param item
     *            the object, which is to be written
     * @throws OAIException
     *             if an error occurs
     */
