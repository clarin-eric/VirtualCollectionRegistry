...
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.CMD.Components.VirtualCollection.Description;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.CMD.Components.VirtualCollection.GeneratedBy.QueryProfile;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.CMD.Components.VirtualCollection.GeneratedBy.QueryValue;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.CMD.Components.VirtualCollection.Name;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.CMD.Components.VirtualCollection.ReproducabilityNotice;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.CMD.Resources.ResourceProxyList.ResourceProxy;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.CMD.Resources.ResourceProxyList.ResourceProxy.ResourceType;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.ComplextypePurpose1;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.ComplextypeReproducability1;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.ComplextypeStatus1;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.ResourcetypeSimple;
import eu.clarin.cmdi.virtualcollectionregistry.model.collection.cmdi.SimpletypePurpose1;
